...
function exp_label_via_l_3_eval_expression(context) {
    // htc_text || '\n' || tipo_via

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('htc_text')  + '\n') + feature.get('tipo_via') );
    } else {
        return ((feature.get('htc_text')  + '\n') + feature.get('tipo_via') );
    }
}
...
function exp_label_Vias_Actuales_4_eval_expression(context) {
    // nombre_via || '\n' || tipo_via

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('nombre_via')  + '\n') + feature.get('tipo_via') );
    } else {
        return ((feature.get('nombre_via')  + '\n') + feature.get('tipo_via') );
    }
}